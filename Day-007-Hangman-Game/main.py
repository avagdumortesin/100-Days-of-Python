...
The project is split into 5 major steps. In each step, there will be multiple To Dos. Your goal is to go through each To Do in order and complete them.

You can view all the To Dos easily in PyCharm by going to View -> Tool Windows -> To Dos
